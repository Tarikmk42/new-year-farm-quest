...
const STAGES = {
    ...
    7: {
        ...
        answer: "БОРЗЫЕ",
        validAnswers: ["БОРЗЫЕ", "БОРЗАЯ", "БОРЗЫЙ"], // Добавлены альтернативные варианты
    ...
    9: {
        ...
        description: "Пройдите в каретный двор. Отгадай, какое яйцо куриное? Расположи яйца в правильной последовательности от большей птицы к меньшей.",
        task: "🔍 Найди куриное яйцо под номером 3",
...
function checkAnswer() {
    ...
    // Проверка для этапа 7 (борзые) - принимаем несколько вариантов
    if (gameState.currentStage === 7) {
        const validAnswers = currentStage.validAnswers || [currentStage.answer];
