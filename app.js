...
const CONFIG = {
    ...
    MAX_SKIPS: 1,
    MAX_LIVES: 3,
    INITIAL_TIME: 90 * 60, // 90 минут для 10 этапов
    DRAW_DATE: '15 января 2025',
    PRIZES: [
...
const STAGES = {
    ...
    3: {
        ...
        task: "🔍 Найди морковку и отнеси её лошадкам (обязательно кормить в присутствии персонала конюшни, который сообщит тебе ответ)",
    ...
    4: {
        ...
        description: "Альпака Плюша спрятала в своём домике волшебную подсказку. Только ультрафиолетовый фонарик поможет её найти!",
    ...
    5: {
        ...
        hint: "💡 Овец нужно посчитать точно, их количество варьируется от 35 до 45",
    ...
    6: {
        ...
        fact: "🐦 Страусы — самые крупные птицы в мире. Их яйцо может весить до 2 кг, а бегать они могут со скоростью до 70 км/ч!",
        answer: "АФРИКАНСКИЙ",
    ...
    7: {
        ...
        description: "Этих грациозных созданий ценят за скорость и изящество. Разгадай загадку о породе собак!",
        task: "🔍 Разгадай загадку о породе собак",
        hint: "💡 Эти собаки известны своей скоростью и используются на охоте",
        joke: "🏃 Что сказала собака-бегун? 'Я не просто бегу, я летаю на четырёх лапах!'",
    ...
    8: {
        ...
        description: "В усадьбе Марьино наши гуси очень добрые! Сделай селфи с нашими добрыми гусями и отправь на номер +79817208061",
...
function checkAnswer() {
    ...
    // Проверка для этапа 5 (овцы) - диапазон 35-45
    if (gameState.currentStage === 5) {
        const numberAnswer = parseInt(userAnswer);
        if (!isNaN(numberAnswer) && numberAnswer >= 35 && numberAnswer <= 45) {
            handleCorrectAnswer();
        } else {
            handleWrongAnswer();
        }
...
function setupEventListeners() {
    ...
    document.getElementById('prizes')?.addEventListener('click', () => {
        showNotification('🎁 Призы разыгрываются 15 января 2025!', 'info');
    });
